...
fn bindgen_test_layout_crypto_aead_aes256gcm_state_() {
    ...
    fn test_field_opaque() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<crypto_aead_aes256gcm_state_>::uninit();
                let ptr = uninit.as_ptr();
...
fn bindgen_test_layout_crypto_hash_sha512_state() {
    ...
    fn test_field_state() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<crypto_hash_sha512_state>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).state) as usize - ptr as usize
            },
            0usize,
...
fn bindgen_test_layout_crypto_auth_hmacsha512_state() {
    ...
    fn test_field_ictx() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<crypto_auth_hmacsha512_state>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).ictx) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_octx() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<crypto_auth_hmacsha512_state>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).octx) as usize - ptr as usize
            },
            208usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_crypto_hash_sha256_state() {
    ...
    fn test_field_state() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<crypto_hash_sha256_state>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).state) as usize - ptr as usize
            },
            0usize,
...
fn bindgen_test_layout_crypto_auth_hmacsha256_state() {
    ...
    fn test_field_ictx() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<crypto_auth_hmacsha256_state>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).ictx) as usize - ptr as usize
            },
            0usize,
...
fn bindgen_test_layout_crypto_generichash_blake2b_state() {
    ...
    fn test_field_opaque() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<crypto_generichash_blake2b_state>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).opaque) as usize - ptr as usize
            },
            0usize,
...
fn bindgen_test_layout_crypto_onetimeauth_poly1305_state() {
    ...
    fn test_field_opaque() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<crypto_onetimeauth_poly1305_state>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).opaque) as usize - ptr as usize
            },
            0usize,
...
fn bindgen_test_layout_crypto_secretstream_xchacha20poly1305_state() {
    ...
    fn test_field_k() {
        assert_eq!(
            unsafe {
                let uninit =
                    ::std::mem::MaybeUninit::<crypto_secretstream_xchacha20poly1305_state>::uninit(
                    );
                let ptr = uninit.as_ptr();
    ...
    fn test_field_nonce() {
        assert_eq!(
            unsafe {
                ...
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).nonce) as usize - ptr as usize
            },
            32usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_crypto_sign_ed25519ph_state() {
    ...
    fn test_field_hs() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<crypto_sign_ed25519ph_state>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).hs) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
...
pub struct randombytes_implementation {
    ...
    pub buf:
        ::std::option::Option<unsafe extern "C" fn(buf: *mut ::std::os::raw::c_void, size: size_t)>,
...
fn bindgen_test_layout_randombytes_implementation() {
    ...
    fn test_field_implementation_name() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<randombytes_implementation>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).implementation_name) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_implementation_name();
    fn test_field_random() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<randombytes_implementation>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).random) as usize - ptr as usize
            },
            8usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_stir() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<randombytes_implementation>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).stir) as usize - ptr as usize
            },
            16usize,
            concat!(
                "Offset of field: ",
...
extern "C" {
    pub fn randombytes_buf(buf: *mut ::std::os::raw::c_void, size: size_t);
}
extern "C" {
...
extern "C" {
    pub fn sodium_memzero(pnt: *mut ::std::os::raw::c_void, len: size_t);
}
extern "C" {
...
extern "C" {
    pub fn sodium_is_zero(n: *const ::std::os::raw::c_uchar, nlen: size_t)
        -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn sodium_increment(n: *mut ::std::os::raw::c_uchar, nlen: size_t);
}
extern "C" {
    pub fn sodium_add(
...
extern "C" {
    pub fn sodium_base64_encoded_len(bin_len: size_t, variant: ::std::os::raw::c_int) -> size_t;
}
extern "C" {
...
extern "C" {
    pub fn sodium_mlock(addr: *mut ::std::os::raw::c_void, len: size_t) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn sodium_munlock(addr: *mut ::std::os::raw::c_void, len: size_t) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn sodium_malloc(size: size_t) -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn sodium_allocarray(count: size_t, size: size_t) -> *mut ::std::os::raw::c_void;
}
extern "C" {
